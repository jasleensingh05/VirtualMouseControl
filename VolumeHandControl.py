...
while True:
    ...
    if len(lmList) != 0:
        ...
        x1, y1 = lineinfo[0], lineinfo[1]  # coordinates of landmark 4
        x2, y2 = lineinfo[2], lineinfo[3]  # coordinates of landmark 8
        ...
        #  Hand range 5 - 300
        #  Volume range -65 - 0
        vol = np.interp(length, [50, 300], [minVol, maxVol])  # convert hand range to volume range
